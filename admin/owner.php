	...
	<table>
		...
		<tr>			
			...
			<td><a onclick='javascript:confirmationDelete($(this));return false;' href="delete_owner.php?uid=<?php echo $value['uid'];  ?>"> <button><i class = 'fas fa-trash'>  Delete</i></button></a></td>
			</tr>
		<?php } ?>
